      ...
      <div className="rounded-md bg-gray-50 p-4 md:p-6">
        ...
        <div className="mb-4">
          ...
          <div className="relative mt-2 rounded-md">
            ...
            <div id='customer-amount-error' aria-live='polite' aria-atomic="true">
        ...
        <fieldset>
            ...
            <div className="flex gap-4">
              <div className="flex items-center">
                <input
                  ...
                  aria-describedby='customer-status-error'
                />
                <label
                  htmlFor="pending"
          ...
          <div id='customer-status-error' aria-live='polite' aria-atomic="true">
